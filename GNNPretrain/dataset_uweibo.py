...
class TreeDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        for filename in tqdm(raw_file_names, desc="Processing news..."):
            ...
            news_text_path = '/home/hpclp/disk/Graphgpt/RAGCL-master/Main/text_embeddings/tweet_text/'
            ...
            for i, comment in enumerate(post['comment']):
                ...
                posts_text_path = '/home/hpclp/disk/Graphgpt/RAGCL-master/Main/text_embeddings/tweet_text/'
