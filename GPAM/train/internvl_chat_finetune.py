...
from internvl.train.constants import (BOX_END_TOKEN, BOX_START_TOKEN,GRAPH_START_TOKEN,
                                      GRAPH_END_TOKEN,GRAPH_CONTEXT_TOKEN,
...
class LazySupervisedDataset(Dataset):
    ...
    def multi_modal_graph_image_get_item(self, data_item):
        # Build transformation function
        transform = self.get_transform()
...
def main():
    ...
    token_list = [GRAPH_START_TOKEN, GRAPH_END_TOKEN, GRAPH_CONTEXT_TOKEN,IMG_START_TOKEN, IMG_END_TOKEN, IMG_CONTEXT_TOKEN,
