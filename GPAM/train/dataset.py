...
def preprocess_internvl2_5(
        ...
        num_graph_token,
        num_image_token_list: list,
        three_modal: bool = False,
        graph_text: bool = False,
    ...
    if three_modal:
        ...
        for conversation in conversations:
            if conversation['from'] == 'human':
                ...
                if '<graph>' in conversation['value']:
                    graph_token_count = num_graph_token
                    graph_tokens = f'{GRAPH_START_TOKEN}{GRAPH_CONTEXT_TOKEN * graph_token_count}{GRAPH_END_TOKEN}'
                    conversation['value'] = conversation['value'].replace('<graph>', graph_tokens, 1)
            new_conversations.append(conversation)
        conversations = new_conversations
